...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file= '../Swin-Transformer-Object-Detection/dataset/data_2305/dataset_train.json',
        classes = classes,
        img_prefix= "../Swin-Transformer-Object-Detection/dataset/data_2305/data_remove_text",
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file='../Swin-Transformer-Object-Detection/dataset/data_2305/dataset_test.json',
        img_prefix='../Swin-Transformer-Object-Detection/dataset/data_2305/data_remove_text',
        pipeline=test_pipeline,
        classes = classes,),
    test=dict(
